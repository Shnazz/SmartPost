...
def show_bad_posture_popup():
    ...
    label = tk.Label(popup, text="Bad Posture Detected!", font=("Arial", 14))
    label.pack(pady=20)
    

def play_alert_sound():
    pygame.mixer.music.load('C:/Users/SylvesterGoh/Downloads/schoool/cap/CapstoneProject/data/bell.mp3')
    ...
    if output:
        ...
        if neck_inclination < 40 and torso_inclination < 10:
            ...
            if not bad_posture_shown:
                ...
                root.after(0, show_bad_posture_popup)
